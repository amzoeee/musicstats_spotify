...
def everything():
    tracks_playtime = pd.read_csv("output/csv/tracks.csv")
    tracks_playcount = tracks_playtime.sort_values("times_played", ascending=False)
    artists_playtime = pd.read_csv("output/csv/artists.csv")
    ...
    file = open("output/txt/tracks_playtime.txt", "w")
    ...
    file = open("output/txt/tracks_playcount.txt", "w")
    ...
    file = open("output/txt/artists_playtime.txt", "w")
    ...
    file = open("output/txt/artists_playcount.txt", "w")
    ...
    file = open("output/txt/artists_uniquetracks.txt", "w")
    file.write("artist stats :D (sorted by playcount)\n")
